...
<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24"><?php esc_html_e( 'My Profile', 'tutor' ); ?>
	<a href="<?php echo site_url() . "/dashboard/settings"; ?>" class="tutor-iconic-btn" title="Edit Profile">
