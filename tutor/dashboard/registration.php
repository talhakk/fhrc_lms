        ...
        <div class="inner">
			...
			<div id="tutor-registration-wrap--">
				...
				<form method="post" enctype="multipart/form-data" id="tutor-registration-form">
					...
					<div class="row">
	                    <div class="col-sm-6">
	                        <label><?php esc_html_e( 'First Name', 'tutor' ); ?> <span>*</span></label>
	                        <input type="text" class="mb-3 form-control" name="first_name" value="<?php echo esc_attr( tutor_utils()->input_old( 'first_name' ) ); ?>"  required autocomplete="given-name">
	                    </div>
	                    <div class="col-sm-6">
	                        <label><?php esc_html_e( 'Last Name', 'tutor' ); ?> <span>*</span></label>
	                        <input type="text" class="mb-3 form-control" name="last_name" value="<?php echo esc_attr( tutor_utils()->input_old( 'last_name' ) ); ?>"  required autocomplete="family-name">
	                    </div>
	                </div>
					...
					<div class="row">
	                    <div class="col-sm-6">
	                        <label><?php esc_html_e( 'User Name', 'tutor' ); ?> <span>*</span></label>
	                        <input type="text" class="mb-3 form-control" name="user_login" class="tutor_user_name" value="<?php echo esc_attr( tutor_utils()->input_old( 'user_login' ) ); ?>"  required autocomplete="username">
	                    </div>
	                    <div class="col-sm-6">
	                        <label><?php esc_html_e( 'E-Mail', 'tutor' ); ?> <span>*</span></label>
	                        <input type="text" class="mb-3 form-control" name="email" value="<?php echo esc_attr( tutor_utils()->input_old( 'email' ) ); ?>"  required autocomplete="email">
	                    </div>
	                </div>
					<!-- <div class="tutor-form-row">
						<div class="tutor-form-col-6">
					...
					<div class="tutor-form-row">
						<div class="tutor-form-col-6">
							<div class="tutor-form-group mb-2">
								<div class="tutor-password-strength-checker">
									<div class="tutor-password-field">
										...
										<input class="password-checker" id="tutor-new-password" type="password" name="password" value="<?php echo esc_attr( tutor_utils()->input_old( 'password' ) ); ?>"  required autocomplete="new-password" style="margin-bottom: 0;">
						...
						<div class="tutor-form-col-6">
							<div class="tutor-form-group">
								...
								<div class="tutor-form-wrap">
									...
									<input type="password" name="password_confirmation" value="<?php echo esc_attr( tutor_utils()->input_old( 'password_confirmation' ) ); ?>"  required autocomplete="new-password" style="margin-bottom: 0;">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="check-wrapper mt-2 d-flex align-items-center justify-content-between">
                   		<div class="form-check">
							...
							<button type="submit" name="tutor_register_student_btn" value="register" class="btn tutor-btn tutor-btn-block"><?php esc_html_e( 'Register', 'tutor' ); ?></button>
						</div>
					</div>
