...
<div class="tutor-wrap tutor-wrap-parent tutor-courses-wrap tutor-container course-archive-page px-3" data-tutor_courses_meta="<?php echo esc_attr(json_encode($GLOBALS['tutor_course_archive_arg'])); ?>">
	...
	<div class="tutor-row tutor-gx-0">
		<?php if ($has_course_filters) : ?>
			<div class="tutor-col-xl-3 tutor-course-filter-container">
...
<style>
	@media (min-width: 575px) {
		.course-archive-page .tutor-grid-3 {
