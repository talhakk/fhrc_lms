...
<div class="tutor-course-topic-single-body">
	...
	<div class="tutor-course-spotlight-wrapper">
        ...
        <div class="details">
        	<div class="students">
                <!-- <ul>
                    <li><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/postimg.png'); ?>" alt=""></li>
                    <li><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/postimg.png'); ?>" alt=""></li>
                    <li><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/postimg.png'); ?>" alt=""></li>
                    <li><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/postimg.png'); ?>" alt=""></li>
                    <li><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/postimg.png'); ?>" alt=""></li>
        	...
        	<div class="comments ">
                <span>
                	<?php
		            	echo get_tutor_option( 'enable_course_update_date' ) ? __( 'Last Updated', 'tutor' ) . ' <strong>' .get_the_modified_date( get_option( 'date_format' ) ).'</strong>'  : null;
		            ?>
		        </span>
		        <?php
			        use TUTOR\Lesson;
		        ...
		        ?>
                <span>Comments: <strong><?php echo $comments_count?></strong></span>
            </div>
        </div>
		<ul class="tutor-nav tutor-course-spotlight-nav">
