...
<!-- <div class="tutor-course-topic-single-footer tutor-px-32 tutor-py-12 tutor-mt-auto">
	<div class="tutor-single-course-content-prev"> -->
		...
		<a class="btn <?php echo ! $previous_id ? 'link' : ''; ?>" href="<?php echo esc_url( $prev_link ); ?>"<?php echo ! $previous_id ? ' disabled="disabled"' : ''; ?>>
	...
	<div class="tutor-single-course-content-next"> -->
		<a class="btn <?php echo ! $next_id ? 'link' : ''; ?>" href="<?php echo esc_url( $next_link ); ?>"<?php echo ! $next_id ? ' disabled="disabled"' : ''; ?>>
